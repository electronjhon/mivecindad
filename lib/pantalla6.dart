...
class pantalla6 extends StatelessWidget {
  ...
  final datosNegocio2 negocio;

  const pantalla6({required this.negocio});
...
class miCardImage3 extends StatelessWidget {
  final String url;
  final String texto;

  const miCardImage3({required this.url, required this.texto});
